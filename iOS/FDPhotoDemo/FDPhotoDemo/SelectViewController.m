...
@property (nonatomic, strong) FDImageCoding  *imageCoding;

@end

@implementation SelectViewController

- (FDImageCoding *)imageCoding {
    if (_imageCoding == nil) {
        _imageCoding = [FDImageCoding new];
    }
    return _imageCoding;
}
...
- (void)initData {
    FDImageCoding *imageCoding = [FDImageCoding unarchiver];
...
- (void)saveImage:(UIImage *)image {
    switch (self.selectImageView.tag) {
        case 0:
            self.imageCoding.image1 = image;
            break;
        case 1:
            self.imageCoding.image2 = image;
            break;
        case 2:
            self.imageCoding.image3 = image;
            break;
        case 3:
            self.imageCoding.image4 = image;
            break;
        default:
            break;
    }
...
- (void)readImageView:(UIImageView *)imageView {
    switch (imageView.tag) {
        case 0:
            imageView.image = self.imageCoding.image1;
            break;
        case 1:
            imageView.image = self.imageCoding.image2;
            break;
        case 2:
            imageView.image = self.imageCoding.image3;
            break;
        case 3:
            imageView.image = self.imageCoding.image4;
            break;
        default:
            break;
    }
